...
PRIVATE_PURCHASE_REASONS = frozenset({
    "INVALID_WALLET", "MISSING_WALLET", "INVALID_INVENTORY_STATE",
    "UNKNOWN_INVENTORY_OWNER", "UNKNOWN_ITEM",
})

AUTHORITY_REASONS = frozenset({
    "WRONG_RUN", "WRONG_ACTOR", "UNKNOWN_OBSERVATION", "UNAUTHORIZED_OBSERVATION",
    "INVALID_SUBMISSION_TIME", "INVALID_CLAIM_REFERENCE", "INVALID_REPLY_REFERENCE",
})
...
GAME_ERROR_CODES = frozenset({
    "INVALID_REQUEST", "GAME_UNAVAILABLE", "OBSERVATION_UNAVAILABLE",
    "KNOWLEDGE_UNAVAILABLE", "ENGINE_ERROR",
})
TURN_FAILURE_CODES = frozenset({
    "OBSERVATION_UNAVAILABLE", "CONTROLLER_ERROR", "INVALID_CONTROLLER_OUTPUT",
    "UNKNOWN_ACTION", "INVALID_PAYLOAD", "INVALID_DURATION", "INVALID_QUANTITY",
    "SUBMISSION_ERROR",
})
